...
export const AppFooter = () => {
  ...
  return (
    <>
      <footer className="px-30 pb-16 mt-35">
        <div className="max-w-[1284px] mx-auto">
          <hr className="border-t-1 border-primary mb-4" />

          <div className="flex justify-between gap-13">
            <img src={cisplatinIcon} />

            <div className="flex items-center xl:gap-40 text-white font-light">
              ...
              <ul className="flex gap-3 text-primary">
                <a href="" className="border-1 rounded-full p-2 transition-colors fill-primary hover:bg-secondary">
                ...
                <a className="border-1 rounded-full p-2 transition-colors fill-primary hover:bg-secondary">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="h-6 w-6">
                    {/* <!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--> */}
